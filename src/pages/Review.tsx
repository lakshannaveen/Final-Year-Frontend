...
function StarRating({ rating, onRatingChange, editable = false }: { rating: number; onRatingChange?: (rating: number) => void; editable?: boolean }) {
  return (
    <div className="flex">
      {[1, 2, 3, 4, 5].map((star) => (
        <button
        ...
        if (deletedReview) {
          ...
          setReviewStats(prev => {
            ...
            const newAverage = newTotal > 0 
              ? (prev.averageRating * prev.totalReviews - deletedReview.rating) / newTotal
              : 0;
            return {
          ...
          <div className="bg-green-50 rounded-lg p-4 mb-6 border border-green-200">
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-gray-700 mt-2">{editingReview.message}</p>
              </div>
