...
export default function Verify({ setCurrentView }: VerifyProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50 py-6 px-4 flex items-center justify-center">
      <div className="w-full max-w-3xl bg-white rounded-2xl shadow-lg border border-green-100 p-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex gap-3">
              ...
              <button
                ...
                className="px-4 py-2 bg-white text-green-700 rounded-lg border border-green-200 hover:bg-green-50 transition"
              >
                Back to Profile
              </button>
            </div>
